...
function versioned(x, f, set) { x = obj(x, f, ["name", "version", "trust_boundary"]); return { name: text(x.name, f + ".name"), version: text(x.version, f + ".version"), trust_boundary: boundary(x.trust_boundary, f + ".trust_boundary", set) }; }
