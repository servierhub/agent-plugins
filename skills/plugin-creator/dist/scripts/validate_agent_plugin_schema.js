...
function validator(r) { const ajv = new Ajv2020({ allErrors: true, strict: true, allowUnionTypes: true }); return ajv.compile(JSON.parse(readFileSync(getSchemaPath(r.version, r.type), "utf8"))); }
