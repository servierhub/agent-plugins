...
function trackedSnapshot(destination:string){
 ...
 for(const extra of ["dist/scripts/efficiency_gate.js","dist/scripts/usage_budget.js","dist/scripts/golden_journeys.js","dist/scripts/decision_comprehension.js","assets/golden-e2e/idea-api-review-skill/fixture.json","assets/golden-e2e/idea-api-review-skill/expected-contract.json","assets/golden-e2e/dependency-review-agent/fixture.json","assets/golden-e2e/dependency-review-agent/expected-contract.json","assets/golden-e2e/multi-component-safety-plugin/fixture.json","assets/golden-e2e/multi-component-safety-plugin/expected-contract.json","assets/decision-comprehension/protocol.json"])if(!entries.some(x=>x.path===PREFIX+extra))entries.push({mode:"100644",path:PREFIX+extra});
