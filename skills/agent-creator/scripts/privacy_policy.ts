...
if (import.meta.url === `file://${process.argv[1]}`) try { main(); } catch (error) { console.error(error instanceof Error ? error.message : "privacy operation failed"); process.exit(1); }
