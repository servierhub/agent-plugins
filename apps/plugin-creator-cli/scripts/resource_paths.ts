...
export const PORTABLE_SKILL_ROOT = resolve(
  process.env.PLUGIN_CREATOR_SKILL_ROOT ?? generatedSkillRoot ?? resolve(REPOSITORY_ROOT, "skills/plugin-creator"),
);
export const portableSkillPath = (...segments: string[]): string => resolve(PORTABLE_SKILL_ROOT, ...segments);
