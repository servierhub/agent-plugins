...
export function generateHtml(ir:ReviewIR){const template=import.meta.url.includes("/$bunfs/")?EMBEDDED_VIEWER_HTML:readFileSync(join(HERE,"viewer.html"),"utf8");return template.replace("/*__EMBEDDED_DATA__*/",`const REVIEW_IR=${safeJson(ir)};`);}
