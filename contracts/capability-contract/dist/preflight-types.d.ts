import type { HostAdapterErrorData, HostCapabilityDegradation, HostCapabilityReport, HostNegotiationRequest, HostNegotiationResult, IsolationLevel } from "./host-adapter-types.js";
...
export type HostPreflightConsequenceCode = "OPTIONAL_CAPABILITY_UNAVAILABLE" | "STATIC_VIEWER_FALLBACK" | "SEQUENTIAL_EXECUTION_FALLBACK" | "CONCURRENCY_LIMITED" | "TOKEN_METRICS_UNAVAILABLE" | "COST_METRICS_UNAVAILABLE";
export interface HostPreflightConsequence {
    code: HostPreflightConsequenceCode;
    message: string;
    capability?: string;
}
export interface HostPreflightMetric {
    value: null;
    available: boolean;
    reason: string | null;
}
export interface HostPreflightJobResult {
    ...
    viewer: {
        requested: "none" | "static" | "live";
        resolved: "none" | "static" | "live";
        reason: string | null;
    };
    metrics: {
        tokens: HostPreflightMetric;
        cost: HostPreflightMetric;
    };
...
export interface HostConcurrencyCapability {
    supported: boolean;
