export declare const COMPATIBILITY_POLICY_VERSION: "1.0.0";
...
export interface CompatibilityDeprecation {
    window: string;
    replacement: string;
}
...
export interface CompatibilityEntry {
    id: string;
    creator: CompatibilityCreator;
    sourceFile: string;
    sourceFieldOrLayout: string;
    sourceEvidence: string;
    kind: CompatibilityKind;
    artifactFormat: CompatibilityArtifactFormat;
    readVersionsOrRanges: readonly string[];
    emittedVersion: string | null;
    versionField: string | null;
    supportState: CompatibilitySupportState;
    deprecation: CompatibilityDeprecation | null;
    migrationId: string | null;
    validatorId: CompatibilityValidatorId;
}
...
export interface CompatibilityShapeValidationResult {
    valid: boolean;
    validatorId: CompatibilityValidatorId | null;
    diagnostic?: CompatibilityDiagnostic;
}
export interface CompatibilityReadResult {
    ok: boolean;
...
export interface MigrationInputFile {
    ...
    entryType: "regular-file" | "directory" | "symlink";
    symlinkTarget?: string;
}
export interface MigrationPreviewOptions {
    migrationId: string;
    files: readonly MigrationInputFile[];
}
...
export interface MigrationPreview {
    ...
    originalSha256: Readonly<Record<string, string>>;
    operations: readonly MigrationCopyOperation[];
    diff: string;
